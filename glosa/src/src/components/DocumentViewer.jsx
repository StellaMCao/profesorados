...
function HighlightTip({ onConfirm, onOpen, customTags = [] }) {
  ...
  if (!isOpen) {
    return (
      <div
        className="bg-indigo-600 text-white text-xs font-semibold px-3.5 py-2 rounded-full cursor-pointer shadow-xl hover:bg-indigo-700 transition-all duration-200 flex items-center gap-1.5 select-none"
  ...
  return (
    <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 p-4 w-80 font-sans z-50">
